...
//             [ tooth, ratio, tooth height, height, base height, name]
belt_T2_5 =    [   2.5,   0.5,          0.7,    1.3,     1.3-0.7, "T2.5 Belt"];
belt_T5 =      [     5,  0.75,          1.2,    2.2,     2.2-1.2, "T5 Belt"];
belt_HTD3 =    [     3,  0.75,         1.22,   2.41,   2.41-1.22, "HTD3 Belt"];
belt_MXL =     [ 2.032,  0.64,         0.46,    1.2,    1.2-0.46, "MXL Belt"];
belt_GT2 =     [     2,   0.5,         0.76,   1.52,   1.52-0.76, "GT2 Belt"];
belt_GT2_3mm = [     3,   0.5,         1.14,   2.41,   2.41-1.14, "GT2-3mm belt"];
