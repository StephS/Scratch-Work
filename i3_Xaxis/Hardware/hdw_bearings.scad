...
bearing_623ZZ =                [    10,      4,    3,    0, 0, false, bearing_tolerance_diameter, bearing_tolerance_inner_diameter, bearing_tolerance_width, "633zz Bearing"];
bearing_633ZZ =                [    13,      5,    3,    0, 0, false, bearing_tolerance_diameter, bearing_tolerance_inner_diameter, bearing_tolerance_width, "633zz Bearing"];
bearing_624ZZ =                [    13,      5,    4,    0, 0, false, bearing_tolerance_diameter, bearing_tolerance_inner_diameter, bearing_tolerance_width, "624zz Bearing"];
bearing_634ZZ =                [    16,      5,    4,    0, 0, false, bearing_tolerance_diameter, bearing_tolerance_inner_diameter, bearing_tolerance_width, "634 Bearing"];
bearing_624_double =           [    13,     10,    4,    0, 0, false, bearing_tolerance_diameter, bearing_tolerance_inner_diameter, bearing_tolerance_width, "two 624 Bearings"];
