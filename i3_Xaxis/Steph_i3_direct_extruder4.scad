...
motor_plate_size=[42,42,mounting_plate_size[2]+motor_z_offset];

main_body_height=idler_obj_width(filament_idler_hole_obj)+idler_obj_width(hobbed_bolt_bearing_hole_obj)*2+3;
...
groove_clamp_screw_obj = screw_obj(screw=screw_M3_socket_head, washer=washer_M3, nut=nut_M3, height=mounting_plate_size[Z_AXIS]);

groove_clamp_screw_hole_obj=screw_obj_tolerance(groove_clamp_screw_obj);
groove_clamp_hole_separation=my_hotend_mount_width+screw_obj_screw_dia(groove_clamp_screw_hole_obj)+2;
groove_clamp_width=groove_clamp_hole_separation+screw_obj_screw_head_top_dia(groove_clamp_screw_hole_obj)+2;
groove_clamp_length=my_hotend_array[0]+my_hotend_array[1];
groove_clamp_tolerance=0.2;

// the screw for the idler hinge. Screw length should be body height
idler_hinge_screw_obj = screw_obj(screw=screw_M3_socket_head, washer=washer_M3, nut=nut_M3, height=mounting_plate_size[Z_AXIS]);
...
// idler gap
//filament_idler_gap=(mounting_plate_size[Z_AXIS]-idler_obj_width(hobbed_bolt_bearing_hole_obj)*2-idler_obj_width(filament_idler_hole_obj))/2+idler_obj_width(hobbed_bolt_bearing_hole_obj);
...
idler_screw=screw_obj(screw=screw_M4_socket_head, height=motor_plate_size[2], head_drop=screw_head_height(screw_M4_socket_head)+motor_z_offset, hole_support=false);
