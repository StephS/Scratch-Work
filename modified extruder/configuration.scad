...
include <Hardware/func_drivetrain.scad>;
...
frame_plate_width = frame_vertex_x*2+frame_threaded_rod_distance+frame_rod_distance_to_edge*2+50;
...
x_carriage_base_support_thickness = 1;
