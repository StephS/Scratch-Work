...
function bearing_name(type)  = type[6];
...
// [outer_diameter, width, inner_diameter, flange_diameter, flange_width, double_flange, name]
bearing_608 =                  [    22,      7,    8,    0, 0, false, "608 Bearing"];
bearing_624 =                  [    16,      5,    4,    0, 0, false, "624 Bearing"];
bearing_624_double =           [    16,     10,    4,    0, 0, false, "two 624 Bearings"];
bearing_R4RS =                 [15.875, 4.9784, 6.35,    0, 0, false, "1/4 inch R4RS bearing"];
bearing_626RS =                [    19,      6,    6,    0, 0, false, "626RS Bearing"];
// Flanged Bearings
bearing_F623zz =               [    10,      4,    3, 11.5, -1, false, "608 Bearing"];
bearing_608_printrbot_guides = [    24,      7,    8,   32, 2,  true, "608 Bearing with belt guide from PrintrBot"];