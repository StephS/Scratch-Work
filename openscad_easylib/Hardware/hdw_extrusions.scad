...
// 10 series 8020 (inch)
extrusion_8020_10s = [25.4, 6.477, 14.859, 2.21, 9.02, 5.2];

// 15 series 8020 (inch)
extrusion_8020_15s = [38.1, 8.128, 20.574, 2.21, 13.487, 6.655];

// 20 series 8020
extrusion_8020_20s = [20, 5.26, 11.99, 1.5, 7.31, 4.19];

// 25 series 8020
extrusion_8020_25s = [25, 6.5, 14.86, 2.14, 8.1, 5];

// 30 series 8020
extrusion_ex_8020_30s = [30, 8.13, 16.5, 2.55, 11.67, 6.5];

// Misumi 2020
extrusion_ex_misumi_2020 = [20, 6, 12, 2, 8, 4.2];